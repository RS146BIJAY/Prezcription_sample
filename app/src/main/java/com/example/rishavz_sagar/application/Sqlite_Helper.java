...
public class Sqlite_Helper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "messages.sqlite";
    public final static String DATABASE_PATH = "/data/data/com.example.rishavz_sagar.application/databases/";
